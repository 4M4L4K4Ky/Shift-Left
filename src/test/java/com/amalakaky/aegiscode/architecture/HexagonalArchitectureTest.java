...
public class HexagonalArchitectureTest {
    ...
    static final ArchRule domain_should_be_isolated =
            noClasses()
                    ...
                    .because("El Dominio (DDD) debe ser agnóstico a frameworks e infraestructura externa.");
    ...
    static final ArchRule infrastructure_should_not_depend_on_application_implementation =
            noClasses()
                    ...
                    .because("La infraestructura solo debe interactuar con la aplicación a través de Puertos (Interfaces).");
}