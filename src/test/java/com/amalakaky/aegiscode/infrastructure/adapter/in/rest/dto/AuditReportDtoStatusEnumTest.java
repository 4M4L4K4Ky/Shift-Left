...
class AuditReportDtoStatusEnumTest {
  ...
  void fromValue_shouldReturnMatchingEnum() {
        assertEquals(AuditReportDto.StatusEnum.IN_PROGRESS,
            AuditReportDto.StatusEnum.fromValue("IN_PROGRESS"));
        assertEquals(AuditReportDto.StatusEnum.COMPLETED,
            AuditReportDto.StatusEnum.fromValue("COMPLETED"));
        assertEquals(AuditReportDto.StatusEnum.FAILED,
            AuditReportDto.StatusEnum.fromValue("FAILED"));
  }

  @Test
  void fromValue_shouldThrowWhenValueUnknown() {
        assertThrows(IllegalArgumentException.class,
            () -> AuditReportDto.StatusEnum.fromValue("INVALID"));
  }
