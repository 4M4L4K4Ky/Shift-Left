...
class AuditEngineApiDelegateDefaultMethodsTest {
    ...
    @Test
    void auditsInlinePost_whenNoRequest_shouldReturnNotImplemented() throws Exception {
        AuditEngineApiDelegate d = new AuditEngineApiDelegate() {};
    ...
    @Test
    void auditsInlinePost_withMatchingAccept_shouldWriteExampleAndReturnNotImplemented() throws Exception {
    ...
    @Test
    void auditsInlinePost_withTextPlainAccept_shouldThrowInvalidMediaType() throws Exception {
        var nativeWebRequest = mock(NativeWebRequest.class);
        when(nativeWebRequest.getHeader("Accept")).thenReturn("text/plain");

        AuditEngineApiDelegate delegate = createDelegateWithRequest(nativeWebRequest);
        org.junit.jupiter.api.Assertions.assertThrows(org.springframework.http.InvalidMediaTypeException.class,
            () -> delegate.auditsInlinePost(new ScanRequestDto()));
    }

    @Test
    void auditsRepositoryPost_whenNoRequest_shouldReturnNotImplemented() throws Exception {
        AuditEngineApiDelegate d = new AuditEngineApiDelegate() {};
    ...
    @Test
    void auditsRepositoryPost_withJsonAccept_shouldWriteExampleAndReturnNotImplemented() throws Exception {
        var nativeWebRequest = mock(NativeWebRequest.class);
        var httpServletResponse = mock(HttpServletResponse.class);
        when(nativeWebRequest.getNativeResponse(HttpServletResponse.class)).thenReturn(httpServletResponse);
        when(httpServletResponse.getWriter()).thenReturn(mock(PrintWriter.class));
    ...
    @Test
    void auditsRepositoryPost_withNonMatchingHeader_shouldSkipApiUtil() throws Exception {
        var nativeWebRequest = mock(NativeWebRequest.class);
        when(nativeWebRequest.getHeader("Accept")).thenReturn("text/plain");
    ...
    @Test
    void auditsStatisticsGet_whenNoRequest_shouldReturnNotImplemented() throws Exception {
        AuditEngineApiDelegate d = new AuditEngineApiDelegate() {};
    ...
    @Test
    void auditsStatisticsGet_withJsonAccept_shouldWriteExampleAndReturnNotImplemented() throws Exception {
        var nativeWebRequest = mock(NativeWebRequest.class);
        var httpServletResponse = mock(HttpServletResponse.class);
        when(nativeWebRequest.getNativeResponse(HttpServletResponse.class)).thenReturn(httpServletResponse);
        when(httpServletResponse.getWriter()).thenReturn(mock(PrintWriter.class));
    ...
    @Test
    void auditsStatisticsGet_withNonMatchingAccept_shouldNotWriteExample() throws Exception {
        var nativeWebRequest = mock(NativeWebRequest.class);
        when(nativeWebRequest.getHeader("Accept")).thenReturn("text/plain");
    ...
    @Test
    void getAuditReport_withRequest_shouldReturnNotImplemented() throws Exception {
        var nativeWebRequest = mock(NativeWebRequest.class);
        AuditEngineApiDelegate delegate = createDelegateWithRequest(nativeWebRequest);
    ...
    @Test
    void getAuditReport_whenNoRequest_shouldReturnNotImplemented() throws Exception {
        AuditEngineApiDelegate d = new AuditEngineApiDelegate() {};
    ...
    private static AuditEngineApiDelegate createDelegateWithRequest(NativeWebRequest nativeWebRequest) {
