            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                ...
                <div className="input-group relative">
                  <svg className="input-icon absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-text-muted pointer-events-none" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.5">
                  ...
                  <input
                    ...
                    className="w-full pl-11 pr-4 py-2.5 rounded-lg bg-bg-primary border border-border-subtle text-white text-sm focus:outline-none focus:border-accent focus:ring-1 focus:ring-accent/50 transition-all placeholder:text-white/40"
              ...
              <div>
                <label className="block text-sm text-text-secondary mb-1.5">Contrasena</label>
                <div className="input-group relative">
                  <svg className="input-icon absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-text-muted pointer-events-none" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.5">
                  ...
                  <input
                    ...
                    className="w-full pl-11 pr-10 py-2.5 rounded-lg bg-bg-primary border border-border-subtle text-white text-sm focus:outline-none focus:border-accent focus:ring-1 focus:ring-accent/50 transition-all placeholder:text-white/40"
                    placeholder="••••••••"
                    required
                  />
                  <button
